                                ...
                                <div id="formdiv">
                                    ...
                                    <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                                        ...
                                        <%
                                            String code="";
                                            String rate="";
                                            if(session.getAttribute("code")!=null&&session.getAttribute("rate")!=null){
                                                code=(String) session.getAttribute("code");
                                                rate=String.valueOf((Double) session.getAttribute("rate"));}%>
                                        <div class="col-md-10 offset-md-1"><input class="form-control" type="text" name="companyCode" placeholder="Company Code" value = "<%=code%>" style="margin-left:0px;font-family:Roboto, sans-serif;"></div>
                                    </div>
                                    <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                        <div class="col-md-8 offset-md-1">
                                            <p style="margin-left:2%;font-family:Roboto, sans-serif;font-size:24px;color:black"><strong>Rate</strong></p>
                                        </div>
                                        <div class="col-md-10 offset-md-1"><input class="form-control" type="text" name="boughtPrice" placeholder="Rate" value = "<%=rate%>"style="margin-left:0px;font-family:Roboto, sans-serif;"></div>
                                    </div>
                                    <div class="form-row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                        <div class="col-md-8 offset-md-1">
